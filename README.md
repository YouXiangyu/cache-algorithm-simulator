...
python main.py -7          # 运行列表中的第 7 个负载（WL09）
...
| 4 | WL05_FIFO_CONVOY | FIFO | 车队循环6次+扰动尾段 | FIFO | 顺序队列对齐 |
| 5 | WL07_SCAN_SANDWICH | ARC | WL08扩展变体，双滑窗+多热集+冷扫描 | ARC | 多阶段自适应 |
| 6 | WL08_ARC_MOSAIC | ARC | 热集/滑窗/冷扫描杂合 | ARC | 多模式混合 |
| 7 | WL09_ADAPTIVE_MIXED | ARC | 多种模式每5000次请求切换 | ARC | 复杂自适应 |
